...
public class UndoRedoManager<T> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Initial State: " + undoRedoManager.currentState.state);

        // Undo operations
        undoRedoManager.undo();
        System.out.println("After undo 1: " + undoRedoManager.currentState.state);
        undoRedoManager.undo();
        System.out.println("After undo 2: " + undoRedoManager.currentState.state);
        undoRedoManager.undo();
        System.out.println("After undo 3: " + undoRedoManager.currentState.state);

        // Redo operations
        undoRedoManager.redo();
        System.out.println("After redo 1: " + undoRedoManager.currentState.state);
        undoRedoManager.redo();
        System.out.println("After redo 2: " + undoRedoManager.currentState.state);
        undoRedoManager.redo();
        System.out.println("After redo 3: " + undoRedoManager.currentState.state);

        // Perform a new action and verify redo stack is cleared
        undoRedoManager.performAction("State 6");
        System.out.println("After new action: " + undoRedoManager.currentState.state);
        undoRedoManager.redo(); // Should not redo anything
    }
}
